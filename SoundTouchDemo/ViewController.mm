...
{
    NSLog(@"播放录音文件");
    NSString *filePath = [[NSBundle mainBundle] pathForResource:@"测试" ofType:@"wav"];
    //NSString *filePath = [[NSBundle mainBundle] pathForResource:@"第一夫人-铃声" ofType:@"mp3"];
